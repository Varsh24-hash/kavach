...
let patients: Patient[] = [
  { 
    ...
    vitals: { heartRate: 72, spO2: 98, respiratoryRate: 16, temperature: 36.8, lastUpdated: new Date().toISOString() }, 
    pdi: 12, 
    status: 'Normal',
  ...
  { 
    ...
    vitals: { heartRate: 115, spO2: 89, respiratoryRate: 28, temperature: 38.5, lastUpdated: new Date().toISOString() }, 
    pdi: 84, 
    status: 'Critical',
    history: Array.from({ length: 20 }, (_, i) => ({
      timestamp: new Date(Date.now() - (20 - i) * 300000).toISOString(),
  ...
  { 
    ...
    vitals: { heartRate: 92, spO2: 94, respiratoryRate: 22, temperature: 37.9, lastUpdated: new Date().toISOString() }, 
    pdi: 56, 
    status: 'Warning',
    history: Array.from({ length: 20 }, (_, i) => ({
      timestamp: new Date(Date.now() - (20 - i) * 300000).toISOString(),
  ...
  { 
    ...
    vitals: { heartRate: 68, spO2: 99, respiratoryRate: 14, temperature: 36.6, lastUpdated: new Date().toISOString() }, 
    pdi: 8, 
    status: 'Normal',
    history: Array.from({ length: 20 }, (_, i) => ({
      timestamp: new Date(Date.now() - (20 - i) * 300000).toISOString(),
